                  ...
                  >
                    <div className="services-grid">
                      <div className="services-section">
                        <h5 className="services-section-title">
                          Banking & Finance
                        </h5>
                        <Link
                          to="/services/regulatory/rbi-cyber-framework"
                          className="services-link"
                        >
                          RBI - Cyber Framework for Banks
                        </Link>
                        <Link
                          to="/services/regulatory/rbi-nbfc-guidelines"
                          className="services-link"
                        >
                          RBI - NBFC Cyber Guidelines
                        </Link>
                        <Link
                          to="/services/regulatory/rbi-payment-systems"
                          className="services-link"
                        >
                          RBI - Payment Systems Audit
                        </Link>
                      </div>
                      <div className="services-section">
                        <h5 className="services-section-title">
                        ...
                        <Link
                          to="/services/regulatory/bse-cyber-audit"
                          className="services-link"
                        >
                          BSE Cyber Security Audit
                        </Link>
                        <Link
                          to="/services/regulatory/nse-cyber-audit"
                          className="services-link"
                        >
                          NSE Cyber Security Audit
                        </Link>
                        <Link
                          to="/services/regulatory/sebi-cyber-audit"
                          className="services-link"
                        >
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/regulatory/data-localization"
                          className="services-link"
                        >
                          Data Localization Audit
                        </Link>
                        <Link
                          to="/services/regulatory/irdai-isnp"
                          className="services-link"
                        >
                          IRDAI - ISNP Security Audit
                        </Link>
                        <Link
                          to="/services/regulatory/uidai-compliance"
                          className="services-link"
                        >
                  ...
                  >
                    <div className="services-grid">
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/web-app-security"
                          className="services-link"
                        >
                          Web App Security (WAST)
                        </Link>
                        <Link
                          to="/services/mobile-app-security"
                          className="services-link"
                        >
                          Mobile App Security (MAST)
                        </Link>
                        <Link
                          to="/services/thick-client-security"
                          className="services-link"
                        >
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/sast-dast"
                          className="services-link"
                        >
                          SAST & DAST
                        </Link>
                        <Link
                          to="/services/source-code-review"
                          className="services-link"
                        >
                          Source Code Review
                        </Link>
                  ...
                  >
                    <div className="services-grid">
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/infrastructure/virtualization"
                          className="services-link"
                        >
                          Virtualization Setup
                        </Link>
                        <Link
                          to="/services/infrastructure/endpoint-management"
                          className="services-link"
                        >
                          Endpoint Management
                        </Link>
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/cloud/penetration-testing"
                          className="services-link"
                        >
                  ...
                  >
                    <div className="services-grid">
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/compliance/iso-27001"
                          className="services-link"
                        >
                          ISO 27001
                        </Link>
                        <Link
                          to="/services/compliance/iso-22301"
                          className="services-link"
                        >
                          ISO 22301
                        </Link>
                        <Link
                          to="/services/compliance/iso-20000"
                          className="services-link"
                        >
                          ISO 20000
                        </Link>
                        <Link
                          to="/services/compliance/iso-42001"
                          className="services-link"
                        >
                          ISO 42001
                        </Link>
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/soc-compliance/soc-1"
                          className="services-link"
                        >
                          SOC 1
                        </Link>
                        <Link
                          to="/services/soc-compliance/soc-2"
                          className="services-link"
                        >
                          SOC 2
                        </Link>
                        <Link
                          to="/services/compliance/pci-dss"
                          className="services-link"
                        >
                          PCI DSS
                        </Link>
                        <Link
                          to="/services/compliance/swift"
                          className="services-link"
                        >
                          SWIFT Assessment
                        </Link>
                        <Link
                          to="/services/compliance/fedramp"
                          className="services-link"
                        >
                          FedRAMP Assessment
                        </Link>
                  ...
                  >
                    <div className="services-grid">
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/privacy/gdpr"
                          className="services-link"
                        >
                          GDPR Compliance
                        </Link>
                        <Link
                          to="/services/privacy/ccpa"
                          className="services-link"
                        >
                          CCPA Compliance
                        </Link>
                        <Link
                          to="/services/privacy/hipaa"
                          className="services-link"
                        >
                          HIPAA Compliance
                        </Link>
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/privacy/dpdp"
                          className="services-link"
                        >
                          DPDP Act Compliance
                        </Link>
                        <Link
                          to="/services/privacy/dpia"
                          className="services-link"
                        >
                          DPIA Services
                        </Link>
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/compliance/iso-27701"
                          className="services-link"
                        >
                          ISO 27701
                        </Link>
                        <Link
                          to="/services/compliance/iso-27018"
                          className="services-link"
                        >
                          ISO 27018
                        </Link>
                  ...
                  >
                    <div className="services-grid">
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/consulting/forensic-audit"
                          className="services-link"
                        >
                          Forensic Audit
                        </Link>
                        <Link
                          to="/services/consulting/ransomware-recovery"
                          className="services-link"
                        >
                          Ransomware Recovery
                        </Link>
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/consulting/virtual-ciso"
                          className="services-link"
                        >
                          Virtual CISO Services
                        </Link>
                        <Link
                          to="/services/consulting/dpo-service"
                          className="services-link"
                        >
                          DPO as a Service
                        </Link>
                      ...
                      <div className="services-section">
                        ...
                        <Link
                          to="/services/consulting/nist-800-53"
                          className="services-link"
                        >
                          NIST 800-53
                        </Link>
                        <Link
                          to="/services/consulting/nist-800-171"
                          className="services-link"
                        >
                          NIST 800-171
                        </Link>
          ...
          >
            ...
            {activeDropdown === "industries" && (
              <div className="dropdown-menu">
                ...
                <Link to="/industries/government" className="dropdown-item">
                  Government
                </Link>
                      ...
                      {mobileActiveService === "regulatory" && (
                        <div className="mobile-service-links">
                          <div className="mobile-service-group">
                            <h6 className="mobile-service-group-title">
                              Banking & Finance
                            </h6>
                            <Link
                              to="/services/regulatory/rbi-cyber-framework"
