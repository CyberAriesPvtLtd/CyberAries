        ...
        <div className="n171-page">
            <section className="n171-hero" style={{ backgroundImage: `url(${heroBgImage})` }}>
                ...
                <div className="n171-container">
                    ...
                    <p className="n171-hero-desc">Secure your defense contracts with specialized compliance. Protecting Controlled Unclassified Information (CUI) is mandatory for all defense contractors under DFARS and CMMC Level 2 requirements. We provide complete support for the 110 security controls defined in NIST SP 800-171, covering everything from CUI scoping and gap assessments to technical implementation. Our expert team ensures you reach C3PAO assessment readiness, safeguarding your eligibility for Department of Defense (DoD) contracts through robust, documented security practices.</p>
