        ...
        <div className="rrec-page">
            <section className="rrec-hero" style={{ backgroundImage: `url(${heroBgImage})` }}>
                ...
                <div className="rrec-container">
                    ...
                    <p className="rrec-hero-desc">Minimize downtime and regain control after a crisis. Ransomware has evolved beyond simple encryption into a complex threat involving double extortion and backup destruction. We provide an integrated crisis response that goes far beyond a basic restore. Our recovery practice includes deep forensic investigation, root cause identification, and secure backup assessment to ensure a clean restoration. From ransom negotiation support to managing regulatory breach notifications and post-recovery security hardening, we help your business mitigate financial losses and emerge more resilient against future attacks.</p>
