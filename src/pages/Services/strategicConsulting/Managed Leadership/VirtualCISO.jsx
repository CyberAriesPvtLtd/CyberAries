        ...
        <div className="vcso-page">
            <section className="vcso-hero" style={{ backgroundImage: `url(${heroBgImage})` }}>
                ...
                <div className="vcso-container">
                    ...
                    <p className="vcso-hero-desc">Access strategic security leadership without the full-time cost. A Virtual Chief Information Security Officer (vCISO) provides your organization with fractional, high-level expertise, enabling effective board engagement and robust regulatory governance. Our vCISO practice delivers a tailored security roadmap, managing everything from risk governance and compliance to third-party risk and executive advisory. By calibrating our services to your specific scale and risk profile, we provide the leadership required by insurers and enterprise customers to prove your commitment to security excellence.</p>
